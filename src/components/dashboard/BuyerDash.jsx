...
const BuyerAccount = () => {
  return (
    <div className=" flex flex-col items-center">
      <div className="buyerDashboardCards grid grid-cols-4 gap-5 py-3 w-full">
        {/*  */}
        <div className="dashboardCard dashcolor flex flex-row p-3 h-32 w-80 justify-center items-center gap-4 rounded-md">
      ...
      <div className="shippingAndDeliveryCards grid grid-cols-2 gap-5 p-0  w-full">
        {/*  */}
        <div className="shippingAndDeliveryCard dashcolor flex flex-col rounded-md text-[14px] px-5 py-3">
        ...
        {/* second card */}
        <div className="shippingAndDeliveryCard dashcolor flex flex-col px-5 py-3 rounded-md text-[14px]">
          <div className="shippingAndDeliveryCardHeader flex flex-row justify-between ">
            <span className="font-semibold text-[16px] text-green-300">
      ...
      {/*  */}
      {/* favoratie products */}
      <div className="favouriteOrLikedProducts w-full flex flex-col dashcolor mt-3 p-3 rounded-md min-h-[200px]">
        <span className="divHeader font-bold opacity-80 py-2">
