...
import TransactionsCard from "../global/cards/TransactionsCard"
import {
  FaBell,
  FaBullseye,
  FaEye,
...
const SellerDashboard = () => {
  return (
    <div className="adminMain flex-1 bg-transparent py-3">
      <div className="dashBoard grid grid-cols-5 gap-3 ">
        <div className="greetingCard col-span-2 ">
          <div className="greetingCardDiv flex flex-row p-2 gap-3 dashcolor rounded-lg ">
        ...
        <div className="miniStatsCard flex flex-col justify-around border dashcolor px-5 py-7 rounded-md">
        ...
        {/*  */}
        <div className="sellerDashSummary col-span-2 flex flex-col px-5 py-5 gap-5 dashcolor rounded-2xl">
          {/* order summary table */}
        ...
        <div className="recentReviewsAndComment col-span-1 flex flex-col gap-3 dashcolor rounded-lg py-2 px-1">
      ...
      {/*  */}
      <div className="yourBestSellingDiv col-span-5 w-full flex flex-col border dashcolor mt-3 rounded-md p-3">
        <span className="bestSellingDivTitle">Your Best Selling Products</span>
        <table>
          <tr>
            <td>
